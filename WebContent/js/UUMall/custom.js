...
==================================================*/
	...
	fn.shoppingCarList = function() {
		var that = this
		  ...
		  , emptyCar = $$(areaEmpty).find('img').attr('src', '../images/UUMall/empty_spCar.png')
	...
	fn.orderConfirm = function() {
		var that = this
		  ...
		  , emptyCoupon = $$(areaEmpty).find('img').attr('src', '../images/UUMall/empty_coupon.png')
		...
		countPayNum = function() {
			var oldNum = 0, newNum = 0
			  , msg = ['尊享个性定制，全场满100减10', '尊享个性定制，全场满200减30', '尊享个性定制，全场满300减50']
