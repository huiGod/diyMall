  ...
  <head>
    ...
    <style>
        *{margin:0;padding:0;}
        ...
        .iframeStyle{position: absolute;top:0;left: 0;overflow:auto;-webkit-overflow-scrolling:touch;}
    </style>
  </head>
  <body>
        <nav class="commonNav">
            ...
            <span class="center">彩铃专区</span>
        </nav> 
        <div class="iframecontain">
            <iframe src="http://iring.diyring.cc/friend/252e5ed28264e505" height="100%" width="100%" frameborder="0" class="iframeStyle"></iframe>
        </div> 
        <script>
