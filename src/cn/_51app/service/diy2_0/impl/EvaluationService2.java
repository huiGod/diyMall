...
@Service
public class EvaluationService2 extends BaseService implements IEvaluationService2 {
	
	@Autowired
	private IEvaluationDao2 dao2;
	...
	public boolean saveEvaluation(Evaluations evaluations){
		try {
			Map<String,Object> map = dao2.getMobile4Order(evaluations.getOrderNo());
			...
			dao2.updateEvaStatus(evaluations.getOrderNo());
			return true;
		} catch (Exception e) {
			return false;
		}
	...
	private void saveEvaluationResolve(EvaluationInfo info,String mobile,String texture) throws Exception{
		...
		dao2.saveEvaluation(info,mobile,texture);
	}
	...
	public String getEvalTypeNum(int goodsId) throws Exception{
		...
		return dao2.getEvalTypeNum(paramMap);
	}
	
	@Override
	public String getEvalTypeNum(int goodsId, int goodsType) throws Exception {
		String cacheKey = OCSKey.DIY_EVALTYPENUM+goodsId+":"+goodsType;
		super.del(cacheKey);
		Map<String,Object> paramMap =new HashMap<String,Object>();
		paramMap.put("cacheKey", cacheKey);
		paramMap.put("cacheTime",10);
	...
	public String findEvalPic(int page,Integer goodsId) throws Exception{
		...
		paramMap.put("goodsId", goodsId);
		return dao2.findEvalPic(paramMap);
	}
	
	@Override
	public String findEvalPic(int page,Integer goodsId, Integer goodsType) throws Exception{
		page-=1;
		String cacheKey = OCSKey.DIY_EVALPIC+":"+goodsId+":"+page+":"+goodsType;
		Map<String,Object> paramMap =new HashMap<String,Object>();
		paramMap.put("cacheKey", cacheKey);
		paramMap.put("cacheTime", 10);
		paramMap.put("page", page*(Integer.parseInt(EVALPICNUM)));
	 ...
	 */
	@Override
	public String findAllEval(int page,int goodsId,Integer evalType, Integer goodsType) throws Exception{
		page-=1;
		String cacheKey = OCSKey.DIY_EVALPIC+goodsId+page+evalType+goodsType;
		del(cacheKey);
		Map<String,Object> paramMap =new HashMap<String,Object>();
		paramMap.put("cacheKey", cacheKey);
		paramMap.put("cacheTime", 10);
		...
		paramMap.put("goodsType", goodsType);
		return dao2.findAllEval(paramMap);
	}
...
//				dao2.saveEvaluation(list.get(i),mobile,text);
				saveEvaluationResolve(list.get(i),mobile,text);
			}
			dao2.updateEvaStatus(evaluations.getOrderNo());
			return true;
